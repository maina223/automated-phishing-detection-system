...
SECRET_KEY = 'django-insecure-l0h+7f&9rxvw)b*^cc+ckwv=+6j&a9=yd3ep((jl#8xpihzv2e'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mydatabase',  # Ensure this is correct
        'USER': 'postgres',  # Make sure this is the correct user
        'PASSWORD': 'database',  # Enter the correct password
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(hours=1),  # Extend access token lifetime
